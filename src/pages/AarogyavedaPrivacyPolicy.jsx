...
function AarogyavedaPrivacyPolicy() {
  return (
    <Wrapper className="section">
      <h1>Privacy Policy</h1>
      <p>
        This privacy policy applies to the Aarogya veda app (hereby referred to
        as "Application") for mobile devices that was created by 7arrow.in
      ...
      <p>
        ...
        identifiable information, including but not limited to email, phone,
        etc. The information that the Service Provider request will be retained
...
export default AarogyavedaPrivacyPolicy;
