  ...
  return (
    <Wrapper className="section">
      ...
      <ul style={{paddingLeft:30}}>
        <li>
          <p style={{lineHeight:0.8}}>Email address</p>
        </li>
        <li>
          <p style={{lineHeight:0.8}}>First name and last name</p>
        </li>
        <li>
          <p style={{lineHeight:0.8}}>Age Group</p>
        </li>
        <li>
          <p style={{lineHeight:0.8}}>Gender</p>
        </li>
        <li>
          <p style={{lineHeight:0.8}}>Users address</p>
        </li>
        <li>
          <p style={{lineHeight:0.8}}>Users Phone No.</p>
        </li>
        {/* <li>
          <p style={{lineHeight:0.8}}>Usage Data</p>
        </li> */}
      </ul>
      <h3>* Usage Data</h3>
      <p style={{paddingLeft:10}}>Usage Data is collected automatically when using the Service.</p>
      <p style={{paddingLeft:10}}>
      ...
      <ul>
        <li><p>
          ...
          refuse Cookies, our Service may use Cookies.</p>
        </li>
        <li><p>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to 7Arrow.in, Near Mahadev temple,
              Kalamba, Kolhapur, Maharashtra 416001.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to 7Arrow.in, accessible from{" "}
              <a
                href="http://www.7Arrow.in"
